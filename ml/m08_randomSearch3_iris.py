...
model = RandomizedSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=1, refit=True, n_jobs=-1, random_state=66, n_iter=20)   # 20 * 5 = 100 . n_iter는 랜덤으로 연산해 줄 갯수를 지정해줌(디폴트: 10)
...
최적의 매개변수 :  RandomForestClassifier(max_depth=8, min_samples_leaf=10, min_samples_split=10)
최적의 파라미터 :  {'n_estimators': 100, 'min_samples_split': 10, 'min_samples_leaf': 10, 'max_depth': 8}
best_score_ :  0.95
model.score :  0.9333333333333333
accuracy_score :  0.9333333333333333
최적 튠 ACC :  0.9333333333333333
걸린시간 :  2.921151638031006

<GridSearchCV>
Fitting 5 folds for each of 71 candidates, totalling 355 fits
최적의 매개변수 :  RandomForestClassifier(max_depth=8, min_samples_leaf=10, min_samples_split=5)
최적의 파라미터 :  {'max_depth': 8, 'min_samples_leaf': 10, 'min_samples_split': 5, 'n_estimators': 100}
best_score_ :  0.9583333333333334
model.score :  0.9666666666666667
accuracy_score :  0.9666666666666667
최적 튠 ACC :  0.9666666666666667
걸린시간 :  7.821737766265869
