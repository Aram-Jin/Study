...
최적의 매개변수 :  RandomForestRegressor(max_depth=8, min_samples_leaf=5, min_samples_split=10,
                      n_estimators=200)
최적의 파라미터 :  {'n_estimators': 200, 'min_samples_split': 10, 'min_samples_leaf': 5, 'max_depth': 8}
best_score_ :  0.498504381082557
model.score :  0.3889960321728132
r2_score :  0.3889960321728132
최적 튠 ACC :  0.3889960321728132
걸린시간 :  3.5746428966522217
...
최적의 매개변수 :  RandomForestRegressor(max_depth=12, min_samples_leaf=5, min_samples_split=10,
                      n_estimators=200)
최적의 파라미터 :  {'max_depth': 12, 'min_samples_leaf': 5, 'min_samples_split': 10, 'n_estimators': 200}
best_score_ :  0.5010608791049548
model.score :  0.3914771307293555
r2_score :  0.3914771307293555
최적 튠 ACC :  0.3914771307293555
걸린시간 :  9.310991764068604
'''