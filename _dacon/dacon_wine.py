...
model1 = RandomForestClassifier(oob_score= True, bootstrap=True, class_weight=None, criterion='gini',
            ...
            min_weight_fraction_leaf=0.0, n_estimators= 2500, n_jobs=None, verbose=0, warm_start=False, random_state=61)

model2 = GradientBoostingClassifier(n_estimators = 750,random_state=66)

model3 = ExtraTreesClassifier(n_estimators = 750,random_state =66)
