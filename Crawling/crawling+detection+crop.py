...
word_list = {'플린 라이더':'fllin', '디즈니 라푼젤':'rapunzel'}      # 폴더명을 한글로 저장하면 에러가 발생해서 영어로 작성해야함. 
n = 20                                                              # 저장할 사진의 장수
...
for keyword, saveword in word_list.items():
    ...
    driver.find_element_by_xpath('//*[@id="yDmH0d"]/div[2]/c-wiz/div[1]/div/div[1]/div[2]/div[2]/div').click()      # 도구-모든크기-큼
