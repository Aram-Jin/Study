...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='C:/Windows/Fonts/HMFMMUEX.TTC', pil=False, example='abc', encoding='utf-8'):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_pil_font(font='C:/Windows/Fonts/HMFMMUEX.TTC' if non_ascii else font,
