...
xy_train = train_datagen.flow_from_directory('../_data/Image/cat_dog/training_set', target_size=(100, 100), batch_size=500, class_mode='binary', shuffle='True')   #keras에서는 fit에 batchsize를 명시해주었지만 다른곳에서는 train데이터에 지정하고 돌려줌
# Found 8005 images belonging to 2 classes.
xy_test = test_datagen.flow_from_directory('../_data/Image/cat_dog/test_set', target_size=(100, 100), batch_size=500, class_mode='binary')
...
# print(xy_train[0][0].shape, xy_train[0][1].shape)     # (5, 200, 200, 3) (5,)
...
hist = model.fit_generator(xy_train, epochs=1000, steps_per_epoch=17, validation_data=xy_test, callbacks=[es])  # steps_per_epochs -> 전체데이터/batchsize = 160/5=32
...
'''
loss :  0.6924548745155334
accuracy :  0.5076618790626526
'''
