...
from tensorflow.keras.layers import Dense, LSTM, Embedding   # layers에서 Embedding 좌표로 바꿔주겠다
...
# =================================================================
#  embedding (Embedding)       (None, 5, 10)             280   -->  input_dim=28 * output_dim=10 / input_length=5 는 연산에 적용되지 않음. 단순히 길이 맞춰주는 역할
#                                                                   Embedding은 벡터화 시켜주는 것
