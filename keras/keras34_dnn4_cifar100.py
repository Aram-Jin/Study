...
#print(x_train.shape, y_train.shape)   # (50000, 3072) (50000, 1)
#print(x_test.shape, y_test.shape)     # (10000, 3072) (10000, 1)
...
model_path = "".join([filepath, 'k34_cifar100_', datetime_spot, '_', filename])
...
'''
loss :  1.6407771110534668
accuracy :  0.40880000591278076
'''