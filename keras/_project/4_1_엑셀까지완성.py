...
'''
'자기자본비율계산에 참여한 계정 펼치기','영업이익증가율계산에 참여한 계정 펼치기','EPS증가율계산에 참여한 계정 펼치기',
'세전계속사업이익률계산에 참여한 계정 펼치기','EBITDA마진율계산에 참여한 계정 펼치기','ROA계산에 참여한 계정 펼치기','ROE계산에 참여한 계정 펼치기','ROIC계산에 참여한 계정 펼치기',
...
# print(total_fs)
    ...
    fs_data_frame.to_csv('Finance.csv', header=True, index=True, encoding='utf-8-sig')
