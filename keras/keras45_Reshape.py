...
model.add(Conv2D(10, kernel_size=(2,2), strides=1,
                 padding='same', input_shape=(28, 28, 1)))     #필터:10  채널:10,10  // padding='same' : shape 맞추는데 사용, padding='valid'는 디폴트값
model.add(MaxPooling2D())                          # (N, 14, 14, 10)
...
model.add(Reshape(target_shape=(100,10)))          # (N, 100, 10)    ======> Reshape을 사용하여 원하는 차원으로 바꿔줄수 있음
